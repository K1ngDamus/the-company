...
**Do not send until the link is real.** See "Before you send" at the bottom.

- **To:** Keyanna@themarshall-law.com
- **From:** Leon Jackson · Front Porch Collective LLC
- **Attachments (3)** — build them with `npm run outbox`, they land in `outbox/`:
...
4. **Check the address:** `Keyanna@themarshall-law.com`.
5. **Send as plain text**, not HTML.
6. **No BCC, no mail-merge, no tracking pixel, no link shortener.** This is one
